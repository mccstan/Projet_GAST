...
private static final SdoGeometryRef _SdoGeometryRefFactory = new SdoGeometryRef();
  ...
  public static SdoGeometryRef cast(ORAData o) throws SQLException
  {
     ...
     try { return (SdoGeometryRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF); }
     catch (Exception exn)
     { throw new SQLException("Unable to convert "+o.getClass().getName()+" to SdoGeometryRef: "+exn.toString()); }
  }
