...
private static final SdoPointTypeRef _SdoPointTypeRefFactory = new SdoPointTypeRef();
  ...
  public static SdoPointTypeRef cast(ORAData o) throws SQLException
  {
     ...
     try { return (SdoPointTypeRef) getORADataFactory().create(o.toDatum(null), OracleTypes.REF); }
     catch (Exception exn)
     { throw new SQLException("Unable to convert "+o.getClass().getName()+" to SdoPointTypeRef: "+exn.toString()); }
  }
