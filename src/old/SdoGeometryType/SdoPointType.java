...
public class SdoPointType implements ORAData, ORADataFactory
{
  ...
  public SdoPointType()
  { _init_struct(true); }
  public SdoPointType(java.math.BigDecimal x, java.math.BigDecimal y, java.math.BigDecimal z) throws SQLException
  { _init_struct(true);
    setX(x);
    setY(y);
    setZ(z);
  ...
  protected ORAData create(SdoPointType o, Datum d, int sqlType) throws SQLException
  {
    if (d == null) return null; 
    if (o == null) o = new SdoPointType();
